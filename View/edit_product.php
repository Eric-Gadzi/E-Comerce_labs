...
<body style="margin: 5% 40%;">
    ...
    <form action="../actions/edit_product.php" method="GET">
        <div class="mb-3">
            ...
            <input type="hidden" value="<?php echo $product_id; ?>" class="form-control" name="product_id" id="product_id" aria-describedby="emailHelp" required>
        </div>
        <div class="mb-3">
            <label for="product_description" class="form-label">Product Description</label>
            <input type="text" value="<?php echo $product_desc;?>" class="form-control" name="description" id="product_description" aria-describedby="emailHelp" required>
        </div>
        <div class="mb-3">
            <label for="product_keywords" class="form-label">Product Keywords</label>
            <input type="text" class="form-control" value="<?php echo $keywords;?>" name="keywords" id="product_keywords" aria-describedby="emailHelp" required>
        </div>
        <div class="mb-3">
            <label for="price" class="form-label">Price</label>
            <input type="number" class="form-control" value="<?php echo $product_price;?>" name="price" id="price" aria-describedby="emailHelp" required>
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <select class="form-select" name="brand_id" id="product_brand" required>
